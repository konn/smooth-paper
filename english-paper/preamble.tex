...
\lstdefinelanguage{algorithm}{
  ...
  morestring=[b]\",
  stringstyle={\slshape},
  keywords={Pick,For,Done,End,in,with,Let,While,Loop,Do,If,Then,Else,Until,Unless,Return,INPUT,OUTPUT},
  numbers=left,
  escapechar=\@,
  keywordstyle={\ul},
  morekeywords=[2]{*,+,/,-,.,\%,!,?,=,<,>,$},
...
\lstdefinelanguage{Haskell}{
 ...
 morekeywords=[2]{*,+,/,-,.,\%,!,?,=,<,>,$},
 keywordstyle=[2]{\ttfamily\bfseries},
 emph={[1] Bool,Char,Double,Either,Float,IO,Int,Maybe,Ordering,Rational,Ratio,ReadS,ShowS,String,UVec,Vec,Functor,PowerSeries,%
	   InPacket,Sing,SNat,Show,Eq,KnownNat,Floating,Ord,Num,SingRep,Void,Monad,Field,Coeff,MyMat,%
           IsOrdPoly, CoeffRing, Ring, Abelian, Commutative, Group, Ideal, Unipol,Strategy,%
           OrdPoly,IsMonomialOrder,MOrder,Coeff,Arity,Lex,Grevlex,Revlex,Homogenised,%
           Additive,Monoidal,OrderedMonomial,Module,LeftModule,Scalar,Type,Polynomial,%
